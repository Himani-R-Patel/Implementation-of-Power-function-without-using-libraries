...
/*****************************************************************
Represents User Interface Class which provides the main window 
to the user to enter the values for x and y.
...
public class View {
	...
	private final JLabel lblFunction = new JLabel("Function 9 : Calculate Power Function \r\nf(x,y) = x ^ y");
    ...
    *****************************************************************/	
	private void initialize() {
		...
		answer.setBounds(190, 199, 130, 35);
		...
		frmSoen.setBounds(100, 100, 450, 300);
		...
		textFieldX.setBounds(85, 72, 78, 35);
		...
		textFieldY.setBounds(266, 72, 78, 35);
		...
		lblAnswer.setBounds(128, 209, 65, 14);
		...
		btnCalculate.addActionListener(new ActionListener() 
		{
			...
			{		
					...
					double y = Double.parseDouble(textFieldY.getText());
    					...
    					{
    					  JOptionPane.showMessageDialog(frmSoen, "The result is undefined since it's result is not universally decided of either 0 or 1","Undefined Result",JOptionPane.ERROR_MESSAGE);
    					}
                        ...
                        {
                          JOptionPane.showMessageDialog(frmSoen, "The result is infinity since it is divided by zero error","Infinity Result",JOptionPane.ERROR_MESSAGE);
                        }
    				    ...
    				    {				
    				       JOptionPane.showMessageDialog(frmSoen, "Please Enter positive value of X and integer value of Y","Invalid Input",JOptionPane.ERROR_MESSAGE);   			
    				    }	
    			}
    		});
		
    		btnCalculate.setBounds(111, 141, 89, 23);
    		...
    		btnReset.setBounds(232, 141, 89, 23);
